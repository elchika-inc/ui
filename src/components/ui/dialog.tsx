...
function DialogOverlay({ className, ...props }: DialogOverlayProps) {
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-overlay supports-backdrop-filter:backdrop-blur-xs transition-opacity duration-slow ease-entrance data-starting-style:opacity-0 data-ending-style:opacity-0 data-ending-style:duration-fast",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-dialog -translate-x-1/2 -translate-y-1/2 gap-4 rounded-lg bg-popover p-4 text-sm text-popover-foreground border border-border shadow-lg outline-none sm:max-w-sm transition-[opacity,scale] duration-slow ease-entrance data-starting-style:opacity-0 data-starting-style:scale-(--motion-scale-lg) data-ending-style:opacity-0 data-ending-style:scale-(--motion-scale-lg) data-ending-style:duration-fast data-instant:transition-none",
          className,
        )}
        {...props}
      >
