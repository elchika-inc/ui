...
const attachmentVariants = cva(
  "group/attachment relative flex w-fit max-w-full min-w-0 shrink-0 flex-wrap rounded-xl border bg-card text-card-foreground transition-colors focus-within:ring-[3px] focus-within:ring-ring has-[>a,>button]:hover:bg-state-hover data-[state=error]:border-destructive/30 data-[state=idle]:border-dashed",
  {
    variants: {
      size: {
        default:
...
function AttachmentTrigger({ className, render, type, ...props }: AttachmentTriggerProps) {
  return useRender({
