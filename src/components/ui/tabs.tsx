  ...
  return (
    <TabsPrimitive.Indicator
      ...
      className={cn(
        ...
        "group-data-[variant=line]/tabs-list:bg-highlight group-data-[variant=line]/tabs-list:group-data-horizontal/tabs:left-(--active-tab-left) group-data-[variant=line]/tabs-list:group-data-horizontal/tabs:w-(--active-tab-width) group-data-[variant=line]/tabs-list:group-data-horizontal/tabs:-bottom-0.5 group-data-[variant=line]/tabs-list:group-data-horizontal/tabs:h-0.5 group-data-[variant=line]/tabs-list:group-data-vertical/tabs:top-(--active-tab-top) group-data-[variant=line]/tabs-list:group-data-vertical/tabs:h-(--active-tab-height) group-data-[variant=line]/tabs-list:group-data-vertical/tabs:-right-0.25 group-data-[variant=line]/tabs-list:group-data-vertical/tabs:w-0.5",
        className,
      )}
      {...props}
    />
