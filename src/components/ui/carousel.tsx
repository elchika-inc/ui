...
export type CarouselProps = React.ComponentProps<"div"> & CarouselOptionsProps;
...
function Carousel({
  ...
  return (
    ...
    >
      {/* biome-ignore lint/a11y/useSemanticElements: 汎用root要素と型契約を維持し、carouselをARIA regionとして公開する。 */}
      <div
...
function CarouselItem({ className, ...props }: CarouselItemProps) {
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: スライドは form fieldset ではなく、ARIA group として公開する。
    <div
      role="group"
