...
const fieldVariants = cva(
  "group/field flex w-full gap-2 data-[invalid=true]:text-destructive data-[invalid=true]:animate-shake",
  {
    variants: {
      orientation: {
...
function Field({ className, orientation = "vertical", ...props }: FieldProps) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: 単一 control にも使う汎用 Field のため fieldset へ限定しない
    <div
      role="group"
      data-slot="field"
...
function FieldLabel({ className, ...props }: FieldLabelProps) {
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-disabled has-data-checked:border-primary has-data-checked:bg-state-selected has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5",
