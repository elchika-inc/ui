...
function ToggleGroup<Value extends string = string>({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-(--toggle-group-gap) rounded-lg data-[size=sm]:rounded-md data-vertical:flex-col data-vertical:items-stretch",
        className,
      )}
      {...props}
    >
