...
function DrawerOverlay({ className, ...props }: DrawerOverlayProps) {
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 min-h-dvh bg-overlay transition-opacity duration-slower ease-entrance select-none data-ending-style:pointer-events-none data-ending-style:opacity-0 data-snap-points:opacity-50 data-starting-style:opacity-0 data-swiping:duration-instant supports-backdrop-filter:backdrop-blur-xs supports-[-webkit-touch-callout:none]:absolute",
        className,
      )}
      {...props}
    />
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Transitions.
            "data-ending-style:transform-(--closed-transform) data-ending-style:opacity-100 data-ending-style:duration-slower data-nested-drawer-swiping:duration-instant data-ending-style:data-nested-drawer-swiping:duration-slower data-starting-style:transform-(--closed-transform) data-swiping:duration-instant data-ending-style:data-swiping:duration-slower",
            // Axis: y.
        ...
        >
          ...
          <DrawerPrimitive.Content
            ...
            className={cn(
              "flex min-h-0 flex-1 flex-col overflow-hidden overscroll-contain transition-opacity duration-slower ease-entrance select-text group-data-nested-drawer-open/drawer-popup:opacity-0 group-data-nested-drawer-swiping/drawer-popup:opacity-100 group-data-swiping/drawer-popup:select-none",
            )}
          >
            {children}
          </DrawerPrimitive.Content>
