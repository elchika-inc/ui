      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Transitions.
            "data-ending-style:transform-(--closed-transform) data-ending-style:opacity-100 data-ending-style:duration-300 data-nested-drawer-swiping:duration-0 data-ending-style:data-nested-drawer-swiping:duration-300 data-starting-style:transform-(--closed-transform) data-swiping:duration-0 data-ending-style:data-swiping:duration-300",
            // Axis: y.
        ...
        >
          ...
          <DrawerPrimitive.Content
            ...
            className={cn(
              "flex min-h-0 flex-1 flex-col overflow-hidden overscroll-contain transition-opacity duration-300 ease-out select-text group-data-nested-drawer-open/drawer-popup:opacity-0 group-data-nested-drawer-swiping/drawer-popup:opacity-100 group-data-swiping/drawer-popup:select-none",
            )}
          >
            {children}
          </DrawerPrimitive.Content>
