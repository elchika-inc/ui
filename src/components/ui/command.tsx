...
function CommandInput({ className, ...props }: CommandInputProps) {
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-8! rounded-lg! border-input/30 bg-card shadow-none! focus-within:border-ring focus-within:ring-3 focus-within:ring-ring *:data-[slot=input-group-addon]:pl-2!">
...
function CommandGroup({ className, ...props }: CommandGroupProps) {
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "overflow-hidden p-1 text-foreground **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-2xs **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:text-muted-foreground",
        className,
      )}
      {...props}
    />
...
function CommandShortcut({ className, ...props }: CommandShortcutProps) {
  return (
    <span
      ...
      className={cn(
        "ml-auto font-mono text-2xs tracking-label text-muted-foreground group-data-selected/command-item:text-foreground",
        className,
      )}
      {...props}
    />
