...
# sheet preview 実ブラウザ検証（overlay 開閉モーション）
...
- preview-selectors.json のselector: `[data-slot="sheet-content"]`。属性遷移の対象: `[data-slot="sheet-content"]`。
- 初期open状態でcomputed styleを測り、「閉じる」をclickして閉じ、先頭の `[data-slot="sheet-trigger"]` をclickして再度開いた。
...
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/sheet/` | 200 | 1 | 0 | 0 | 0 | false | false |
| dark | `/preview/sheet-dark/` | 200 | 1 | 0 | 0 | 0 | true | false |

## computed style（開いた状態の生値）

| theme | 対象 | transition-property | transition-duration | transition-timing-function |
|---|---|---|---|---|
| light | popup | `opacity, translate` | `0.4s` | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | popup | `opacity, translate` | `0.4s` | `cubic-bezier(0.16, 1, 0.3, 1)` |
...
|---|---:|---:|---:|---:|---:|---|---|
| light | 54 | 26 | 63 | 451.2 | 465.4 | `0.4s` | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | 53 | 26 | 66.3 | 466 | 481.4 | `0.4s` | `cubic-bezier(0.16, 1, 0.3, 1)` |

閉じるtransitionの最後に採れた値:

- light: opacity `8.24887e-06`、scale `none`、translate `39.9997px`、transform `none`。
- dark: opacity `2.77556e-15`、scale `none`、translate `40px`、transform `none`。
...
- light: [2026-09-16-sheet-preview-light.jpg](2026-09-16-sheet-preview-light.jpg)
- dark: [2026-09-16-sheet-preview-dark.jpg](2026-09-16-sheet-preview-dark.jpg)
