...
# alert-dialog preview 実ブラウザ検証（overlay 開閉モーション）
...
- preview-selectors.json のselector: `[data-slot="alert-dialog-content"]`。属性遷移の対象: `[data-slot="alert-dialog-content"]`。
- 初期open状態でcomputed styleを測り、「キャンセル」をclickして閉じ、先頭の `[data-slot="alert-dialog-trigger"]` をclickして再度開いた。
...
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/alert-dialog/` | 200 | 1 | 0 | 0 | 0 | false | false |
| dark | `/preview/alert-dialog-dark/` | 200 | 1 | 0 | 0 | 0 | true | false |
...
|---|---:|---:|---:|---:|---:|---|---|
| light | 14 | 9 | 58 | 178.7 | 195 | `0.12s` | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | 15 | 9 | 70.2 | 194.3 | 208.7 | `0.12s` | `cubic-bezier(0.16, 1, 0.3, 1)` |

閉じるtransitionの最後に採れた値:

- light: opacity `0`、scale `0.96`、translate `-50% -50%`、transform `none`。
- dark: opacity `2.49954e-06`、scale `0.96`、translate `-50% -50%`、transform `none`。
...
- light: [2026-09-16-alert-dialog-preview-light.jpg](2026-09-16-alert-dialog-preview-light.jpg)
- dark: [2026-09-16-alert-dialog-preview-dark.jpg](2026-09-16-alert-dialog-preview-dark.jpg)
