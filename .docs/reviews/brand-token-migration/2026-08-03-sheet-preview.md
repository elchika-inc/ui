...
|---|---|---|---|---|---|---|---|
| dark | `/preview/sheet-dark/` | class / data-theme / color-scheme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-sheet-preview-dark.jpg` (1280×900, 21499 bytes) |
| light | `/preview/sheet/` | class / data-theme / color-scheme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-sheet-preview-light.jpg` (1280×900, 21464 bytes) |
