...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/checkbox-dark/` | class/data-theme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `checkbox-preview-dark.jpg` (1512×828, 53878 bytes) |
| light | `/preview/checkbox/` | class/data-theme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `checkbox-preview-light.jpg` (1512×828, 54028 bytes) |

## 判定

- unchecked/checked/mixed/disabledの状態とkeyboard focusを確認した。
