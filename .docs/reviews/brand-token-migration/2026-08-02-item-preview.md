...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/item-dark/` | class/data-theme一致 | `rgba(22, 24, 29, 0.97)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `item-preview-dark.jpg` (1512×828, 59911 bytes) |
| light | `/preview/item/` | class/data-theme一致 | `rgba(245, 245, 246, 0.918)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `item-preview-light.jpg` (1512×828, 59469 bytes) |

## 判定

- interactive itemのhover/focus stateを確認した。
