...
|---|---|---|---|---|---|---|---|
| dark | `/preview/context-menu-dark/` | class / data-theme / color-scheme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | `DIV`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-context-menu-preview-dark.jpg` (1280×900, 23419 bytes) |
| light | `/preview/context-menu/` | class / data-theme / color-scheme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | `DIV`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-context-menu-preview-light.jpg` (1280×900, 22423 bytes) |
