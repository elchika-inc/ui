...
# navigation-menu ブランドトークン実ブラウザ証跡
...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/navigation-menu-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `navigation-menu-preview-dark.jpg` (1512×828, 58558 bytes) |
| light | `/preview/navigation-menu/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `navigation-menu-preview-light.jpg` (1512×828, 57773 bytes) |

## 判定

- trigger/contentのopen stateとkeyboard focusを確認した。
