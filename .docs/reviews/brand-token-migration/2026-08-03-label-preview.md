...
|---|---|---|---|---|---|---|---|
| dark | `/preview/label-dark/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | `INPUT`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-label-preview-dark.jpg` (1280×900, 14432 bytes) |
| light | `/preview/label/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | `INPUT`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-label-preview-light.jpg` (1280×900, 14299 bytes) |
