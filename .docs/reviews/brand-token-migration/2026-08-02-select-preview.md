...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/select-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | visible focusable controlなし | 0 | なし | `select-preview-dark.jpg` (1512×828, 67851 bytes) |
| light | `/preview/select/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | visible focusable controlなし | 0 | なし | `select-preview-light.jpg` (1512×828, 67741 bytes) |

## 判定

- placeholder SelectとInputが同じopaque surface/control borderへ解決し、disabled hoverでもbackground-image noneを維持した。
