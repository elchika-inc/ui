...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/field-dark/` | class/data-theme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `field-preview-dark.jpg` (1512×828, 96272 bytes) |
| light | `/preview/field/` | class/data-theme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `field-preview-light.jpg` (1512×828, 97696 bytes) |

## 判定

- selected/invalid境界とkeyboard focusを確認した。
