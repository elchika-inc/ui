...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/radio-group-dark/` | class/data-theme一致 | `rgb(110, 147, 240)` / `rgb(28, 31, 38)` | focus-visible確認 | 0 | なし | `radio-group-preview-dark.jpg` (1512×828, 79659 bytes) |
| light | `/preview/radio-group/` | class/data-theme一致 | `rgb(47, 95, 209)` / `rgb(255, 255, 255)` | focus-visible確認 | 0 | なし | `radio-group-preview-light.jpg` (1512×828, 79763 bytes) |

## 判定

- 選択状態とkeyboard focusを確認した。
