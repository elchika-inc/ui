...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/card-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(150, 156, 168)` | visible focusable controlなし | 0 | なし | `card-preview-dark.jpg` (1512×828, 78314 bytes) |
| light | `/preview/card/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(99, 103, 111)` | visible focusable controlなし | 0 | なし | `card-preview-light.jpg` (1512×828, 78770 bytes) |

## 判定

- surface・foreground・muted foregroundのlight/dark解決を確認した。
