...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/input-group-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `input-group-preview-dark.jpg` (1512×828, 73001 bytes) |
| light | `/preview/input-group/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `input-group-preview-light.jpg` (1512×828, 73739 bytes) |

## 判定

- 通常・invalid状態を確認した。disabled InputGroupは現previewから到達不能のため未測定。
