...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/button-dark/` | class/data-theme一致 | `rgb(111, 148, 240)` / `rgb(28, 31, 38)` | focus-visible確認 | 0 | なし | `button-preview-dark.jpg` (1512×828, 61600 bytes) |
| light | `/preview/button/` | class/data-theme一致 | `rgb(46, 92, 203)` / `rgb(255, 255, 255)` | focus-visible確認 | 0 | なし | `button-preview-light.jpg` (1512×828, 62493 bytes) |

## 判定

- primary hoverとdestructive default/hoverを実pointerで作り、いずれも文字contrast 4.5:1以上を確認した。
