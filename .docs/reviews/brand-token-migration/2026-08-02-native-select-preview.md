...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/native-select-dark/` | class/data-theme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `native-select-preview-dark.jpg` (1512×828, 81227 bytes) |
| light | `/preview/native-select/` | class/data-theme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `native-select-preview-light.jpg` (1512×828, 81585 bytes) |

## 判定

- disabled controlはwrapper opacity 1、control opacity var(--opacity-disabled)で二重合成がないことを確認した。
