...
|---|---|---|---|---|---|---|---|
| dark | `/preview/hover-card-dark/` | class / data-theme / color-scheme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-hover-card-preview-dark.jpg` (1280×900, 20407 bytes) |
| light | `/preview/hover-card/` | class / data-theme / color-scheme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-hover-card-preview-light.jpg` (1280×900, 20212 bytes) |
