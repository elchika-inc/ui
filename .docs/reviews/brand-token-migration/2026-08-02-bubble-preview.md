...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/bubble-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | visible focusable controlなし | 0 | なし | `bubble-preview-dark.jpg` (1512×828, 86865 bytes) |
| light | `/preview/bubble/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | visible focusable controlなし | 0 | なし | `bubble-preview-light.jpg` (1512×828, 86035 bytes) |

## 判定

- primary/destructiveの静的pairを確認した。interactive hoverは現previewから到達不能のため未測定。
