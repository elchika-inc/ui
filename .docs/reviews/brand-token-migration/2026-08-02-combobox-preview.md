...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/combobox-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `combobox-preview-dark.jpg` (1512×828, 67072 bytes) |
| light | `/preview/combobox/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `combobox-preview-light.jpg` (1512×828, 67146 bytes) |

## 判定

- triggerのpointer/keyboard状態とtheme同期を確認した。
