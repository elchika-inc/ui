...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/drawer-dark/` | class/data-theme一致 | `rgb(21, 23, 28)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `drawer-preview-dark.jpg` (1512×828, 76585 bytes) |
| light | `/preview/drawer/` | class/data-theme一致 | `rgb(246, 246, 247)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `drawer-preview-light.jpg` (1512×828, 75027 bytes) |
