...
|---|---|---|---|---|---|---|---|
| dark | `/preview/skeleton-dark/` | class / data-theme / color-scheme一致 | `rgb(38, 42, 51)` / `rgb(246, 246, 247)` | `BODY`、focus-visible=false、indicator=false | 0 / 0 / 0 | なし | `2026-08-03-skeleton-preview-dark.jpg` (1280×900, 8099 bytes) |
| light | `/preview/skeleton/` | class / data-theme / color-scheme一致 | `rgb(237, 238, 240)` / `rgb(26, 28, 33)` | `BODY`、focus-visible=false、indicator=false | 0 / 0 / 0 | なし | `2026-08-03-skeleton-preview-light.jpg` (1280×900, 7914 bytes) |
