...
|---|---|---|---|---|---|---|---|
| dark | `/preview/sonner-dark/` | class / data-theme / color-scheme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | `LI`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-sonner-preview-dark.jpg` (1280×900, 14043 bytes) |
| light | `/preview/sonner/` | class / data-theme / color-scheme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | `LI`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-sonner-preview-light.jpg` (1280×900, 13654 bytes) |
