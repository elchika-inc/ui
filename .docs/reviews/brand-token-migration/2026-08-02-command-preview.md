...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/command-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `command-preview-dark.jpg` (1512×828, 83366 bytes) |
| light | `/preview/command/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `command-preview-light.jpg` (1512×828, 84717 bytes) |

## 判定

- 入力・項目のpointer/keyboard状態とtheme同期を確認した。
