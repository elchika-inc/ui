...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/badge-dark/` | class/data-theme一致 | `rgb(38, 42, 51)` / `rgb(246, 246, 247)` | visible focusable controlなし | 0 | なし | `badge-preview-dark.jpg` (1512×828, 39411 bytes) |
| light | `/preview/badge/` | class/data-theme一致 | `rgb(237, 238, 240)` / `rgb(26, 28, 33)` | visible focusable controlなし | 0 | なし | `badge-preview-light.jpg` (1512×828, 39427 bytes) |
