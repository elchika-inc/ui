...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/input-dark/` | class/data-theme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `input-preview-dark.jpg` (1512×828, 58371 bytes) |
| light | `/preview/input/` | class/data-theme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `input-preview-light.jpg` (1512×828, 58335 bytes) |
