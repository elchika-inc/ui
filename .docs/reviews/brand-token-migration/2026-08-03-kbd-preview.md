...
|---|---|---|---|---|---|---|---|
| dark | `/preview/kbd-dark/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | `BODY`、focus-visible=false、indicator=false | 0 / 0 / 0 | なし | `2026-08-03-kbd-preview-dark.jpg` (1280×900, 10881 bytes) |
| light | `/preview/kbd/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | `BODY`、focus-visible=false、indicator=false | 0 / 0 / 0 | なし | `2026-08-03-kbd-preview-light.jpg` (1280×900, 10853 bytes) |
