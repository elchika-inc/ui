...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/input-otp-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(150, 156, 168)` | focus-visible確認 | 0 | なし | `input-otp-preview-dark.jpg` (1512×828, 60197 bytes) |
| light | `/preview/input-otp/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(99, 103, 111)` | focus-visible確認 | 0 | なし | `input-otp-preview-light.jpg` (1512×828, 60529 bytes) |

## 判定

- 入力slotと前後controlのkeyboard focusを確認した。
