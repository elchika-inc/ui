...
|---|---|---|---|---|---|---|---|
| dark | `/preview/tooltip-dark/` | class / data-theme / color-scheme一致 | `rgb(246, 246, 247)` / `rgb(21, 23, 28)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-tooltip-preview-dark.jpg` (1280×900, 18900 bytes) |
| light | `/preview/tooltip/` | class / data-theme / color-scheme一致 | `rgb(26, 28, 33)` / `rgb(246, 246, 247)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-tooltip-preview-light.jpg` (1280×900, 18123 bytes) |
