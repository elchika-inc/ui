...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/table-dark/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | visible focusable controlなし | 0 | なし | `table-preview-dark.jpg` (1512×828, 82814 bytes) |
| light | `/preview/table/` | class/data-theme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | visible focusable controlなし | 0 | なし | `table-preview-light.jpg` (1512×828, 80405 bytes) |

## 判定

- header/body/row surfaceとforegroundのlight/dark解決を確認した。
