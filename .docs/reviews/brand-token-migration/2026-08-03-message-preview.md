...
|---|---|---|---|---|---|---|---|
| dark | `/preview/message-dark/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-message-preview-dark.jpg` (1280×900, 33588 bytes) |
| light | `/preview/message/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-message-preview-light.jpg` (1280×900, 34292 bytes) |
