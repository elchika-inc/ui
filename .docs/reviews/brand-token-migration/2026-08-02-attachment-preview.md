...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/attachment-dark/` | class/data-theme一致 | `rgba(246, 246, 247, 0)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `attachment-preview-dark.jpg` (1512×828, 66644 bytes) |
| light | `/preview/attachment/` | class/data-theme一致 | `rgba(26, 28, 33, 0)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `attachment-preview-light.jpg` (1512×828, 67073 bytes) |
