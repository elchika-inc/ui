...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/tabs-dark/` | class/data-theme一致 | `rgb(28, 31, 38)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `tabs-preview-dark.jpg` (1512×828, 41768 bytes) |
| light | `/preview/tabs/` | class/data-theme一致 | `rgb(255, 255, 255)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `tabs-preview-light.jpg` (1512×828, 41639 bytes) |

## 判定

- inactiveはopaque muted foreground、activeはforegroundへ解決し、light/darkともsensor AAを満たした。
