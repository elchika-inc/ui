...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/alert-dialog-dark/` | class/data-theme一致 | `rgba(22, 24, 29, 0.92)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `alert-dialog-preview-dark.jpg` (1512×828, 75069 bytes) |
| light | `/preview/alert-dialog/` | class/data-theme一致 | `rgba(246, 246, 247, 0.97)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `alert-dialog-preview-light.jpg` (1512×828, 73216 bytes) |
