...
|---|---|---|---|---|---|---|---|
| dark | `/preview/empty-dark/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(246, 246, 247)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-empty-preview-dark.jpg` (1280×900, 20551 bytes) |
| light | `/preview/empty/` | class / data-theme / color-scheme一致 | `rgba(0, 0, 0, 0)` / `rgb(26, 28, 33)` | `BUTTON`、focus-visible=true、indicator=true | 0 / 0 / 0 | なし | `2026-08-03-empty-preview-light.jpg` (1280×900, 20465 bytes) |
