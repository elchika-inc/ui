...
|---|---|---|---|---|---:|---|---|
| dark | `/preview/sidebar-dark/` | class/data-theme一致 | `rgb(21, 23, 28)` / `rgb(246, 246, 247)` | focus-visible確認 | 0 | なし | `sidebar-preview-dark.jpg` (1512×828, 83435 bytes) |
| light | `/preview/sidebar/` | class/data-theme一致 | `rgb(246, 246, 247)` / `rgb(26, 28, 33)` | focus-visible確認 | 0 | なし | `sidebar-preview-light.jpg` (1512×828, 83007 bytes) |

## 判定

- sidebar foreground/accentの面と文字のpair、およびfocus stateを確認した。
