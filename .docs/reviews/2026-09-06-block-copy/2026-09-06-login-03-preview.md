...
# login-03 preview 実ブラウザー検証（文言・デモデータの日本語化）
...
- selector: `[data-slot="login-03-preview"]`。light / darkは別の隔離preview routeを個別に開いた。

## 実測結果

| theme | route | HTTP | selector件数 | lang | pageerror | console error | dark class | scrollWidth / clientWidth | toolbar |
|---|---|---:|---:|---|---:|---:|---|---|---:|
| light | `/preview/login-03/` | 200 | 1 | `ja` | 0 | 0 | false | 1440 / 1440 | 0 |
| dark | `/preview/login-03-dark/` | 200 | 1 | `ja` | 0 | 0 | true | 1440 / 1440 | 0 |
...
- light: [2026-09-06-login-03-preview-light.jpg](2026-09-06-login-03-preview-light.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
- dark: [2026-09-06-login-03-preview-dark.jpg](2026-09-06-login-03-preview-dark.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
