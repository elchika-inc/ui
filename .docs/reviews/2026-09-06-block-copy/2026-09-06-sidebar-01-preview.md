...
# sidebar-01 preview 実ブラウザー検証（文言・デモデータの日本語化）
...
- selector: `[data-slot="sidebar-01-preview"]`。light / darkは別の隔離preview routeを個別に開いた。

## 実測結果

| theme | route | HTTP | selector件数 | lang | pageerror | console error | dark class | scrollWidth / clientWidth | toolbar |
|---|---|---:|---:|---|---:|---:|---|---|---:|
| light | `/preview/sidebar-01/` | 200 | 1 | `ja` | 0 | 0 | false | 1440 / 1440 | 0 |
| dark | `/preview/sidebar-01-dark/` | 200 | 1 | `ja` | 0 | 0 | true | 1440 / 1440 | 0 |

両テーマで `document.documentElement.lang === "ja"`、pageerror 0、`scrollWidth <= clientWidth` を実測した。

## 証跡画像

- light: [2026-09-06-sidebar-01-preview-light.jpg](2026-09-06-sidebar-01-preview-light.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
- dark: [2026-09-06-sidebar-01-preview-dark.jpg](2026-09-06-sidebar-01-preview-dark.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
