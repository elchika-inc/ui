...
# thinking-states preview 実ブラウザ検証
...
| --- | --- | --- | --- | --- | --- | --- |
| light | `/preview/thinking-states/` | 200 | 1 | 0 | 0 | 0 |
| dark | `/preview/thinking-states-dark/` | 200 | 1 | 0 | 0 | 0 |

preview selector: `[data-slot="thinking-states-preview"]`。両themeでdark classはrouteと一致、reduced-motionはfalse。
...
| --- | --- | --- | --- | --- |
| light | 関連する情報を整理しています | 1 | opacity: 0.12s / 222.2ms, translate: 0.12s / 222.3ms | 0 |
| dark | 関連する情報を整理しています | 1 | opacity: 0.12s / 204.6ms, translate: 0.12s / 204.7ms | 0 |
...
rootのrole=statusを確認。SpinnerとTextSwapの組合せで、registryDependenciesは `@elchika/spinner` / `@elchika/text-swap`。

## 証跡画像と判定範囲

- light: [2026-09-16-thinking-states-preview-light.jpg](2026-09-16-thinking-states-preview-light.jpg)
- dark: [2026-09-16-thinking-states-preview-dark.jpg](2026-09-16-thinking-states-preview-dark.jpg)
