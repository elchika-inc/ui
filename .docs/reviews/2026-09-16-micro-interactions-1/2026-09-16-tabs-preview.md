...
# tabs preview 実ブラウザ検証（状態遷移とマイクロインタラクション）
...
- selector: `[data-slot="tabs"]`。computed style は担当要素の先頭を測った。

## 表示・エラーの実測

| theme | route | HTTP | selector 件数 | console error（favicon 除外） | favicon 404 | pageerror | dark class | reduced motion |
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/tabs/` | 200 | 2 | 0 | 0 | 0 | false | false |
| dark | `/preview/tabs-dark/` | 200 | 2 | 0 | 0 | 0 | true | false |
...
|---|---|---|---:|---|---:|---|---:|---|---|
| light | default | `left` | 260 | `cubic-bezier(0.16, 1, 0.3, 1)` | 22 | `45px` | 45 | false | 42 × 25 |
| light | line | `left` | 260 | `cubic-bezier(0.16, 1, 0.3, 1)` | 24 | `49px` | 49 | false | 42 × 2 |
| dark | default | `left` | 260 | `cubic-bezier(0.16, 1, 0.3, 1)` | 22 | `45px` | 45 | false | 42 × 25 |
| dark | line | `left` | 260 | `cubic-bezier(0.16, 1, 0.3, 1)` | 24 | `49px` | 49 | false | 42 × 2 |
...
|---|---|---|---|---:|
| light | default | `0 0 #0000` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px` | 0.0 |
| light | line | `0 0 #0000` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px` | 0.0 |
| dark | default | `0 0 #0000` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px` | 0.0 |
| dark | line | `0 0 #0000` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px` | 0.0 |

## 証跡画像と判定範囲

- light: [2026-09-16-tabs-preview-light.jpg](2026-09-16-tabs-preview-light.jpg)
- dark: [2026-09-16-tabs-preview-dark.jpg](2026-09-16-tabs-preview-dark.jpg)
