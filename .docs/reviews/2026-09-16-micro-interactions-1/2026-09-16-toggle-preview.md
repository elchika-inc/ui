...
# toggle preview 実ブラウザ検証（状態遷移とマイクロインタラクション）
...
- selector: `[data-slot="toggle-preview"]`。computed style は担当要素の先頭を測った。

## 表示・エラーの実測

| theme | route | HTTP | selector 件数 | console error（favicon 除外） | favicon 404 | pageerror | dark class | reduced motion |
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/toggle/` | 200 | 1 | 0 | 0 | 0 | false | false |
| dark | `/preview/toggle-dark/` | 200 | 1 | 0 | 0 | 0 | true | false |
...
- light: [2026-09-16-toggle-preview-light.jpg](2026-09-16-toggle-preview-light.jpg)
- dark: [2026-09-16-toggle-preview-dark.jpg](2026-09-16-toggle-preview-dark.jpg)
