...
# button preview 実ブラウザ検証（状態遷移とマイクロインタラクション）
...
- selector: `[data-slot="button"]`。computed style は担当要素の先頭を測った。

## 表示・エラーの実測

| theme | route | HTTP | selector 件数 | console error（favicon 除外） | favicon 404 | pageerror | dark class | reduced motion |
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/button/` | 200 | 11 | 0 | 1 | 0 | false | false |
| dark | `/preview/button-dark/` | 200 | 11 | 0 | 0 | 0 | true | false |

404 の URL は別の新規 Chromium で `console.location().url` を再取得し、`http://127.0.0.1:52771/favicon.ico` であることを確認した。
...
- light: [2026-09-16-button-preview-light.jpg](2026-09-16-button-preview-light.jpg)
- dark: [2026-09-16-button-preview-dark.jpg](2026-09-16-button-preview-dark.jpg)
