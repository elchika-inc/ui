...
# progress preview 実ブラウザ検証（状態遷移とマイクロインタラクション）
...
- selector: `[data-slot="progress-preview"]`。computed style は担当要素の先頭を測った。

## 表示・エラーの実測

| theme | route | HTTP | selector 件数 | console error（favicon 除外） | favicon 404 | pageerror | dark class | reduced motion |
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/progress/` | 200 | 1 | 0 | 0 | 0 | false | false |
| dark | `/preview/progress-dark/` | 200 | 1 | 0 | 0 | 0 | true | false |

## computed style（生値）

| theme | transition-property | transition-duration | transition-timing-function |
|---|---|---|---|
| light | `width` | `0.26s` | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | `width` | `0.26s` | `cubic-bezier(0.16, 1, 0.3, 1)` |

## 証跡画像と判定範囲

- light: [2026-09-16-progress-preview-light.jpg](2026-09-16-progress-preview-light.jpg)
- dark: [2026-09-16-progress-preview-dark.jpg](2026-09-16-progress-preview-dark.jpg)
