...
# input-otp preview 実ブラウザ検証（状態遷移とマイクロインタラクション）
...
- selector: `[data-slot="input-otp-preview"]`。computed style は担当要素の先頭を測った。

## 表示・エラーの実測

| theme | route | HTTP | selector 件数 | console error（favicon 除外） | favicon 404 | pageerror | dark class | reduced motion |
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/input-otp/` | 200 | 1 | 0 | 0 | 0 | false | false |
| dark | `/preview/input-otp-dark/` | 200 | 1 | 0 | 0 | 0 | true | false |
...
- light: [2026-09-16-input-otp-preview-light.jpg](2026-09-16-input-otp-preview-light.jpg)
- dark: [2026-09-16-input-otp-preview-dark.jpg](2026-09-16-input-otp-preview-dark.jpg)
