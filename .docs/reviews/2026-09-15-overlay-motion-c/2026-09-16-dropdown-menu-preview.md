...
# dropdown-menu preview 実ブラウザ検証（overlay モーション統一 PR C）
...
- 生データは [browser-results.json](browser-results.json) の component=`dropdown-menu` に記録した。画像は開いた状態を各テーマ1枚撮影した。

## 存在・実行の実測

| theme | route | HTTP | preview selector 件数 | console error | pageerror | favicon error | dark class | 横 overflow |
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/dropdown-menu/` | 200 | 1 | 0 | 0 | 0 | false | なし |
| dark | `/preview/dropdown-menu-dark/` | 200 | 1 | 0 | 0 | 0 | true | なし |

`preview-selectors.json` の selector は `[data-slot="dropdown-menu-content"]`、動作の実測対象は `[data-slot="dropdown-menu-content"]`。
...
|---|---|---|---|---|---|---|---|---:|---:|
| light | `0.26s` | `cubic-bezier(0.16, 1, 0.3, 1)` | `opacity, scale` | あり | なし（null） | trigger click | `0.12s` | 8 | 132.400 |
| dark | `0.26s` | `cubic-bezier(0.16, 1, 0.3, 1)` | `opacity, scale` | あり | なし（null） | trigger click | `0.12s` | 9 | 131.600 |
...
- light: [2026-09-16-dropdown-menu-preview-light.jpg](2026-09-16-dropdown-menu-preview-light.jpg)（1440×900 / JPEG、SHA-256 `606f1ef460a769c3879ac5cca784b4ac8e6630b28e05f345cf6741e0618806b8`）。
- dark: [2026-09-16-dropdown-menu-preview-dark.jpg](2026-09-16-dropdown-menu-preview-dark.jpg)（1440×900 / JPEG、SHA-256 `5d313bbe40c9ea82cdf1252afe5619caeb7375ce2d7d31a0b72995e7a9806411`）。
