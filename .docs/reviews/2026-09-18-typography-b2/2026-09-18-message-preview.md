...
# message preview 実ブラウザ検証（組版と Mono）
...
- preview selector: `[data-slot="message-preview"]`。

MessageHeader・MessageFooter・actionClassName の text-2xs 全9要素を測定した。

## 表示とエラー

| theme | route | HTTP | selector数 | lang | dark class | console error（favicon除外） | favicon 404 | pageerror | scrollWidth / clientWidth |
|---|---|---|---|---|---|---|---|---|---|
| light | `/preview/message/` | 200 | 1 | ja | false | 0 | 0 | 0 | 1440 / 1440 |
| dark | `/preview/message-dark/` | 200 | 1 | ja | true | 0 | 0 | 0 | 1440 / 1440 |
...
|---|---|---|---|---|---|
| light | message-header | 12px | 18px | 0.32px | 3 |
| light | message-footer | 12px | 18px | 0.32px | 3 |
| light | BUTTON | 12px | 18px | 0.32px | 3 |
| dark | message-header | 12px | 18px | 0.32px | 3 |
| dark | message-footer | 12px | 18px | 0.32px | 3 |
| dark | BUTTON | 12px | 18px | 0.32px | 3 |
...
- light: [2026-09-18-message-preview-light.jpg](2026-09-18-message-preview-light.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
- dark: [2026-09-18-message-preview-dark.jpg](2026-09-18-message-preview-dark.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
