...
# sidebar-16 preview 実ブラウザ検証（組版と Mono）
...
- preview selector: `[data-slot="sidebar-16-preview"]`。

初期表示にある text-2xs の全要素と SidebarGroupLabel を測定した。ナビゲーション内の省略記号は既存の truncate による表示。

## 表示とエラー

| theme | route | HTTP | selector数 | lang | dark class | console error（favicon除外） | favicon 404 | pageerror | scrollWidth / clientWidth |
|---|---|---|---|---|---|---|---|---|---|
| light | `/preview/sidebar-16/` | 200 | 1 | ja | false | 0 | 0 | 0 | 1440 / 1440 |
| dark | `/preview/sidebar-16-dark/` | 200 | 1 | ja | true | 0 | 0 | 0 | 1440 / 1440 |
...
- light: [2026-09-18-sidebar-16-preview-light.jpg](2026-09-18-sidebar-16-preview-light.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
- dark: [2026-09-18-sidebar-16-preview-dark.jpg](2026-09-18-sidebar-16-preview-dark.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
