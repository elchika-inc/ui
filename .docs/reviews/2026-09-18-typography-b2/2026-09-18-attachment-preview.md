...
# attachment preview 実ブラウザ検証（組版と Mono）
...
- preview selector: `[data-slot="attachment-preview"]`。

既定 preview の description 3要素を測定した。size sm / xs の13px指定は変更しておらず、その組合せの描画は今回の範囲外。

## 表示とエラー

| theme | route | HTTP | selector数 | lang | dark class | console error（favicon除外） | favicon 404 | pageerror | scrollWidth / clientWidth |
|---|---|---|---|---|---|---|---|---|---|
| light | `/preview/attachment/` | 200 | 1 | ja | false | 0 | 1 | 0 | 1440 / 1440 |
| dark | `/preview/attachment-dark/` | 200 | 1 | ja | true | 0 | 0 | 0 | 1440 / 1440 |
...
|---|---|---|---|---|---|
| light | attachment-description | 12px | 18px | 0.32px | 3 |
| dark | attachment-description | 12px | 18px | 0.32px | 3 |
...
- light: [2026-09-18-attachment-preview-light.jpg](2026-09-18-attachment-preview-light.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
- dark: [2026-09-18-attachment-preview-dark.jpg](2026-09-18-attachment-preview-dark.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
