...
# sidebar-07 preview 実ブラウザ検証（組版と Mono）
...
- preview selector: `[data-slot="sidebar-07-preview"]`。

先頭のチーム切替ボタン（menu-button / aria-haspopup=menu）を開き、チームラベルとプラン・メールの12px表示を測定した。

## 表示とエラー

| theme | route | HTTP | selector数 | lang | dark class | console error（favicon除外） | favicon 404 | pageerror | scrollWidth / clientWidth |
|---|---|---|---|---|---|---|---|---|---|
| light | `/preview/sidebar-07/` | 200 | 1 | ja | false | 0 | 0 | 0 | 1440 / 1440 |
| dark | `/preview/sidebar-07-dark/` | 200 | 1 | ja | true | 0 | 0 | 0 | 1440 / 1440 |
...
|---|---|---|---|---|---|
| light | SPAN | 12px | 18px | 0.32px | 2 |
| light | dropdown-menu-label | 12px | 18px | 0.32px | 1 |
| dark | SPAN | 12px | 18px | 0.32px | 2 |
...
- light: [2026-09-18-sidebar-07-preview-light.jpg](2026-09-18-sidebar-07-preview-light.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
- dark: [2026-09-18-sidebar-07-preview-dark.jpg](2026-09-18-sidebar-07-preview-dark.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
