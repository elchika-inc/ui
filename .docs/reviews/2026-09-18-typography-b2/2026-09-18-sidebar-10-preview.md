...
# sidebar-10 preview 実ブラウザ検証（組版と Mono）
...
- preview selector: `[data-slot="sidebar-10-preview"]`。

先頭のチーム切替ボタン（menu-button / aria-haspopup=menu）を開き、今回変更したチームラベルの12px表示を測定・撮影した。

## 表示とエラー

| theme | route | HTTP | selector数 | lang | dark class | console error（favicon除外） | favicon 404 | pageerror | scrollWidth / clientWidth |
|---|---|---|---|---|---|---|---|---|---|
| light | `/preview/sidebar-10/` | 200 | 1 | ja | false | 0 | 0 | 0 | 1440 / 1440 |
| dark | `/preview/sidebar-10-dark/` | 200 | 1 | ja | true | 0 | 0 | 0 | 1440 / 1440 |
...
- light: [2026-09-18-sidebar-10-preview-light.jpg](2026-09-18-sidebar-10-preview-light.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
- dark: [2026-09-18-sidebar-10-preview-dark.jpg](2026-09-18-sidebar-10-preview-dark.jpg) — 1440×900 JPEG、magic bytes `FF D8 FF`。
