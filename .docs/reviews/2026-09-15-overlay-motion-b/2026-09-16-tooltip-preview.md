...
# tooltip preview 実ブラウザ検証（overlay モーション統一 PR B）
...
- `preview-selectors.json` の `[data-slot="tooltip-content"]` を使用した。初期 open をいったん閉じ、trigger hover で開き、pointer を (1400, 850) へ移して閉じる。
...
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/tooltip/` | 200 | 1 | 0 | 0 | 0 | false | なし |
| dark | `/preview/tooltip-dark/` | 200 | 1 | 0 | 0 | 0 | true | なし |
...
|---|---|---|---|---|---:|---:|---|---|
| light | `0.12s` | `cubic-bezier(0.16, 1, 0.3, 1)` | `opacity, scale` | `0.08s` | 6 | 93.000 | あり | なし（hasAttribute=false / getAttribute=null） |
| dark | `0.12s` | `cubic-bezier(0.16, 1, 0.3, 1)` | `opacity, scale` | `0.08s` | 6 | 93.100 | あり | なし（hasAttribute=false / getAttribute=null） |
...
通常の hover open では両テーマとも data-instant なし。tooltip は§Bの規定どおり無条件に `data-instant:transition-none` を付けた。

## 証跡画像

- light: [2026-09-16-tooltip-preview-light.jpg](2026-09-16-tooltip-preview-light.jpg)（1440×900 / JPEG）。
- dark: [2026-09-16-tooltip-preview-dark.jpg](2026-09-16-tooltip-preview-dark.jpg)（1440×900 / JPEG）。
