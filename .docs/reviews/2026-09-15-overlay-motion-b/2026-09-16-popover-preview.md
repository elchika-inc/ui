...
# popover preview 実ブラウザ検証（overlay モーション統一 PR B）
...
- `preview-selectors.json` の `[data-slot="popover-content"]` を使用した。初期 open をいったん閉じ、trigger click。
...
|---|---|---:|---:|---:|---:|---:|---|---|
| light | `/preview/popover/` | 200 | 1 | 0 | 0 | 0 | false | なし |
| dark | `/preview/popover-dark/` | 200 | 1 | 0 | 0 | 0 | true | なし |
...
|---|---|---|---|---|---:|---:|---|---|
| light | `0.26s` | `cubic-bezier(0.16, 1, 0.3, 1)` | `opacity, scale` | `0.12s` | 9 | 139.800 | あり | なし（hasAttribute=false / getAttribute=null） |
| dark | `0.26s` | `cubic-bezier(0.16, 1, 0.3, 1)` | `opacity, scale` | `0.12s` | 9 | 142.500 | あり | なし（hasAttribute=false / getAttribute=null） |
...
- light: [2026-09-16-popover-preview-light.jpg](2026-09-16-popover-preview-light.jpg)（1440×900 / JPEG）。
- dark: [2026-09-16-popover-preview-dark.jpg](2026-09-16-popover-preview-dark.jpg)（1440×900 / JPEG）。
