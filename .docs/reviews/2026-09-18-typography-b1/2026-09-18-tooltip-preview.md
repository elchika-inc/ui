...
# tooltip preview 実ブラウザ検証（組版と Mono）

## 成功基準と対象

成功基準は [委任仕様 §4・§B](../../plans/2026-09-17-typography-layer.md) と司令塔の追加裁定。TooltipContent を text-2xs にした。
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `/preview/tooltip/` | 200 | 1 | 0 | 0 | 0 | false |
| dark | `/preview/tooltip-dark/` | 200 | 1 | 0 | 0 | 0 | true |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `tooltip-content` / 共通 UI の補足情報です | 12px | 18px | 0.32px | 400 | normal | 30 / 30 |
| dark | `tooltip-content` / 共通 UI の補足情報です | 12px | 18px | 0.32px | 400 | normal | 30 / 30 |

computed fontFamily（light / dark で一致）:

- 共通 UI の補足情報です: `"IBM Plex Sans JP", "IBM Plex Sans", system-ui, sans-serif`。

## 画像と判定範囲

- light: [2026-09-18-tooltip-preview-light.jpg](2026-09-18-tooltip-preview-light.jpg)。
- dark: [2026-09-18-tooltip-preview-dark.jpg](2026-09-18-tooltip-preview-dark.jpg)。
