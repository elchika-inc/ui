...
# command preview 実ブラウザ検証（組版と Mono）

## 成功基準と対象

成功基準は [委任仕様 §4・§B](../../plans/2026-09-17-typography-layer.md) と司令塔の追加裁定。shortcut を font-mono text-2xs tracking-label に統一し、司令塔裁定で cmdk-group-heading も text-2xs にした。
...
```css
[cmdk-group-heading], [data-slot="command-shortcut"]
```
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `/preview/command/` | 200 | 4 | 0 | 0 | 0 | false |
| dark | `/preview/command-dark/` | 200 | 4 | 0 | 0 | 0 | true |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `cmdk-group-heading` / 操作 | 12px | 18px | 0.32px | 500 | normal | 30 / 30 |
| light | `command-shortcut` / ⌘P | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| light | `command-shortcut` / ⌘B | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| light | `command-shortcut` / ⌘S | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| dark | `cmdk-group-heading` / 操作 | 12px | 18px | 0.32px | 500 | normal | 30 / 30 |
| dark | `command-shortcut` / ⌘P | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| dark | `command-shortcut` / ⌘B | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| dark | `command-shortcut` / ⌘S | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |

computed fontFamily（light / dark で一致）:

- 操作: `"IBM Plex Sans JP", "IBM Plex Sans", system-ui, sans-serif`。
- ⌘P / ⌘B / ⌘S: `"IBM Plex Mono", "IBM Plex Sans JP", ui-monospace, monospace`。

## 画像と判定範囲

- light: [2026-09-18-command-preview-light.jpg](2026-09-18-command-preview-light.jpg)。
- dark: [2026-09-18-command-preview-dark.jpg](2026-09-18-command-preview-dark.jpg)。
