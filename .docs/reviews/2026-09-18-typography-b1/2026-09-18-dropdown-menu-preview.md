...
# dropdown-menu preview 実ブラウザ検証（組版と Mono）
...
```css
[data-slot="dropdown-menu-label"], [data-slot="dropdown-menu-shortcut"]
```
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `/preview/dropdown-menu/` | 200 | 3 | 0 | 0 | 0 | false |
| dark | `/preview/dropdown-menu-dark/` | 200 | 3 | 0 | 0 | 0 | true |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `dropdown-menu-label` / ファイル | 12px | 18px | 0.32px | 500 | normal | 26 / 26 |
| light | `dropdown-menu-shortcut` / ⌘K | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| light | `dropdown-menu-label` / 並び順 | 12px | 18px | 0.32px | 500 | normal | 26 / 26 |
| dark | `dropdown-menu-label` / ファイル | 12px | 18px | 0.32px | 500 | normal | 26 / 26 |
| dark | `dropdown-menu-shortcut` / ⌘K | 12px | 18px | 0.96px | 400 | normal | 18 / 18 |
| dark | `dropdown-menu-label` / 並び順 | 12px | 18px | 0.32px | 500 | normal | 26 / 26 |
...
- light: [2026-09-18-dropdown-menu-preview-light.jpg](2026-09-18-dropdown-menu-preview-light.jpg)。
- dark: [2026-09-18-dropdown-menu-preview-dark.jpg](2026-09-18-dropdown-menu-preview-dark.jpg)。
