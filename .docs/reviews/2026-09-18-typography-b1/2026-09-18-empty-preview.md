...
# empty preview 実ブラウザ検証（組版と Mono）

## 成功基準と対象

成功基準は [委任仕様 §4・§B](../../plans/2026-09-17-typography-layer.md) と司令塔の追加裁定。title の tracking-tight を tracking-heading に置換した。
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `/preview/empty/` | 200 | 1 | 0 | 0 | 0 | false |
| dark | `/preview/empty-dark/` | 200 | 1 | 0 | 0 | 0 | true |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| light | `empty-title` / まだプロジェクトがありません | 14px | 21px | -0.14px | 500 | normal | 21 / 21 |
| dark | `empty-title` / まだプロジェクトがありません | 14px | 21px | -0.14px | 500 | normal | 21 / 21 |

computed fontFamily（light / dark で一致）:

- まだプロジェクトがありません: `"IBM Plex Sans JP", "IBM Plex Sans", system-ui, sans-serif`。

fontFeatureSettings は light / dark とも `"palt"`、字間は -0.14px（14px × -0.01em）。Mono はタイトルへ適用していない。

## 画像と判定範囲

- light: [2026-09-18-empty-preview-light.jpg](2026-09-18-empty-preview-light.jpg)。
- dark: [2026-09-18-empty-preview-dark.jpg](2026-09-18-empty-preview-dark.jpg)。
