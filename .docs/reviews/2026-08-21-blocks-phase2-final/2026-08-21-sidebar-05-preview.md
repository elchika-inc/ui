...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-05/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-05-case27-light.jpg](evidence/sidebar-05-case27-light.jpg) (43152 bytes) |
| dark | `/preview/sidebar-05-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-05-case28-dark.jpg](evidence/sidebar-05-case28-dark.jpg) (43645 bytes) |

preview selector: `[data-slot="sidebar-05-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
