...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/login-05/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [login-05-case07-light.jpg](evidence/login-05-case07-light.jpg) (31682 bytes) |
| dark | `/preview/login-05-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [login-05-case08-dark.jpg](evidence/login-05-case08-dark.jpg) (31771 bytes) |

preview selector: `[data-slot="login-05-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
