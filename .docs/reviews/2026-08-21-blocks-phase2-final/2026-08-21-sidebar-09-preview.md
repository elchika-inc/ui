...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-09/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-09-case35-light.jpg](evidence/sidebar-09-case35-light.jpg) (79094 bytes) |
| dark | `/preview/sidebar-09-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-09-case36-dark.jpg](evidence/sidebar-09-case36-dark.jpg) (83705 bytes) |

preview selector: `[data-slot="sidebar-09-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
