...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-08/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-08-case33-light.jpg](evidence/sidebar-08-case33-light.jpg) (38738 bytes) |
| dark | `/preview/sidebar-08-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-08-case34-dark.jpg](evidence/sidebar-08-case34-dark.jpg) (38853 bytes) |

preview selector: `[data-slot="sidebar-08-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
