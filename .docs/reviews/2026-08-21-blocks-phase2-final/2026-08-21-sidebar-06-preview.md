...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-06/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-06-case29-light.jpg](evidence/sidebar-06-case29-light.jpg) (36302 bytes) |
| dark | `/preview/sidebar-06-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-06-case30-dark.jpg](evidence/sidebar-06-case30-dark.jpg) (36450 bytes) |

preview selector: `[data-slot="sidebar-06-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
