...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-12/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-12-case41-light.jpg](evidence/sidebar-12-case41-light.jpg) (39751 bytes) |
| dark | `/preview/sidebar-12-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-12-case42-dark.jpg](evidence/sidebar-12-case42-dark.jpg) (41983 bytes) |

preview selector: `[data-slot="sidebar-12-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
