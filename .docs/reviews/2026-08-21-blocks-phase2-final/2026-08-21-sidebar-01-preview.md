...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-01/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-01-case19-light.jpg](evidence/sidebar-01-case19-light.jpg) (43485 bytes) |
| dark | `/preview/sidebar-01-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-01-case20-dark.jpg](evidence/sidebar-01-case20-dark.jpg) (44550 bytes) |

preview selector: `[data-slot="sidebar-01-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
