...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/signup-02/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-02-case11-light.jpg](evidence/signup-02-case11-light.jpg) (46496 bytes) |
| dark | `/preview/signup-02-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-02-case12-dark.jpg](evidence/signup-02-case12-dark.jpg) (46405 bytes) |

preview selector: `[data-slot="signup-02-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
