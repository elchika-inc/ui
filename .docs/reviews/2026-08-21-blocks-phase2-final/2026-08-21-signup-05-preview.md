...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/signup-05/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-05-case17-light.jpg](evidence/signup-05-case17-light.jpg) (32815 bytes) |
| dark | `/preview/signup-05-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-05-case18-dark.jpg](evidence/signup-05-case18-dark.jpg) (32736 bytes) |

preview selector: `[data-slot="signup-05-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
