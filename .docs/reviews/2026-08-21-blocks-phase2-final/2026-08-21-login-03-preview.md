...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/login-03/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [login-03-case03-light.jpg](evidence/login-03-case03-light.jpg) (40737 bytes) |
| dark | `/preview/login-03-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [login-03-case04-dark.jpg](evidence/login-03-case04-dark.jpg) (39979 bytes) |

preview selector: `[data-slot="login-03-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
