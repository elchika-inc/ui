...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-15/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-15-case47-light.jpg](evidence/sidebar-15-case47-light.jpg) (78721 bytes) |
| dark | `/preview/sidebar-15-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-15-case48-dark.jpg](evidence/sidebar-15-case48-dark.jpg) (79314 bytes) |

preview selector: `[data-slot="sidebar-15-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
