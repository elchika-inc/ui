...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/signup-03/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-03-case13-light.jpg](evidence/signup-03-case13-light.jpg) (42355 bytes) |
| dark | `/preview/signup-03-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-03-case14-dark.jpg](evidence/signup-03-case14-dark.jpg) (40051 bytes) |

preview selector: `[data-slot="signup-03-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
