...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-07/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-07-case31-light.jpg](evidence/sidebar-07-case31-light.jpg) (36185 bytes) |
| dark | `/preview/sidebar-07-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-07-case32-dark.jpg](evidence/sidebar-07-case32-dark.jpg) (36391 bytes) |

preview selector: `[data-slot="sidebar-07-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
