...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-03/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-03-case23-light.jpg](evidence/sidebar-03-case23-light.jpg) (44667 bytes) |
| dark | `/preview/sidebar-03-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-03-case24-dark.jpg](evidence/sidebar-03-case24-dark.jpg) (45619 bytes) |

preview selector: `[data-slot="sidebar-03-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
