...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/signup-01/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-01-case09-light.jpg](evidence/signup-01-case09-light.jpg) (46983 bytes) |
| dark | `/preview/signup-01-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-01-case10-dark.jpg](evidence/signup-01-case10-dark.jpg) (45466 bytes) |

preview selector: `[data-slot="signup-01-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
