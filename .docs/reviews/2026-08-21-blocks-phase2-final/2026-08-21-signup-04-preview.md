...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/signup-04/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-04-case15-light.jpg](evidence/signup-04-case15-light.jpg) (50583 bytes) |
| dark | `/preview/signup-04-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [signup-04-case16-dark.jpg](evidence/signup-04-case16-dark.jpg) (48830 bytes) |

preview selector: `[data-slot="signup-04-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
