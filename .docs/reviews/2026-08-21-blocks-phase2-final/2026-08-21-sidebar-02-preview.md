...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-02/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-02-case21-light.jpg](evidence/sidebar-02-case21-light.jpg) (44449 bytes) |
| dark | `/preview/sidebar-02-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-02-case22-dark.jpg](evidence/sidebar-02-case22-dark.jpg) (44810 bytes) |

preview selector: `[data-slot="sidebar-02-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
