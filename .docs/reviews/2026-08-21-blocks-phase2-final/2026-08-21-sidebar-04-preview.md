...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-04/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-04-case25-light.jpg](evidence/sidebar-04-case25-light.jpg) (44956 bytes) |
| dark | `/preview/sidebar-04-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-04-case26-dark.jpg](evidence/sidebar-04-case26-dark.jpg) (46636 bytes) |

preview selector: `[data-slot="sidebar-04-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
