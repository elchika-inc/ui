...
|---|---|---:|---:|---|---|---|---:|---|
| light | `/preview/sidebar-11/` | 200 | 1/1 | data-theme=light, dark=false | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-11-case39-light.jpg](evidence/sidebar-11-case39-light.jpg) (42914 bytes) |
| dark | `/preview/sidebar-11-dark/` | 200 | 1/1 | data-theme=dark, dark=true | なし | pageerror 0, console 0, HTTP4xx5xx 0, failure 0 | 0 | [sidebar-11-case40-dark.jpg](evidence/sidebar-11-case40-dark.jpg) (43879 bytes) |

preview selector: `[data-slot="sidebar-11-preview"]`。light/dark 2/2 routeで可視、JPEG magic bytesを実測確認した。
