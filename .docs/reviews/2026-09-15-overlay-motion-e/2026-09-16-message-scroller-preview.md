...
# message-scroller のモーショントークン移行検証
...
- 変更: duration-200 → duration-base、duration-400 → duration-slower、ease-in → ease-standard、ease-out → ease-entrance。
...
|---|---|---|---:|---:|---|---|
| light | `/preview/message-scroller/` | `[data-slot="message-scroller-preview"]` | 1 | 200 | 0 / 0 / 0 | [2026-09-16-message-scroller-preview-light.jpg](2026-09-16-message-scroller-preview-light.jpg) |
| dark | `/preview/message-scroller-dark/` | `[data-slot="message-scroller-preview"]` | 1 | 200 | 0 / 0 / 0 | [2026-09-16-message-scroller-preview-dark.jpg](2026-09-16-message-scroller-preview-dark.jpg) |
    ...
    "computed": [
      {
        ...
        "property": "translate, scale, opacity",
        "animation": "none",
