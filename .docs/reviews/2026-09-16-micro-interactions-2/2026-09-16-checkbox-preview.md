...
# checkbox preview 実ブラウザ検証（マイクロインタラクション）
...
- preview selector: `[data-slot="checkbox-preview"]`。

## 表示・エラー

| theme | route | HTTP | selector件数 | console error（favicon除外） | favicon 404 | pageerror | dark class | reduced motion |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| light | `/preview/checkbox/` | 200 | 1 | 0 | 0 | 0 | false | false |
| dark | `/preview/checkbox-dark/` | 200 | 1 | 0 | 0 | 0 | true | false |
...
`[data-preview-checkbox="unchecked"]` を click して出現、再度 click して退場を測定した。その子の `[data-slot="checkbox-indicator"]` が対象。

| theme | 出現 sample 数 | starting sample 数 |
| --- | --- | --- |
| light | 25 | 1 |
| dark | 24 | 0 |
...
| --- | --- | --- | --- | --- | --- |
| light | 27 | 9 | 32.3 | 162.2 | 177.1 |
| dark | 27 | 9 | 32.2 | 161.5 | 177.7 |
...
| --- | --- | --- | --- | --- | --- |
| light | open | CSSTransition | opacity | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| light | open | CSSTransition | scale | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| light | close | CSSTransition | opacity | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| light | close | CSSTransition | scale | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | open | CSSTransition | opacity | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | open | CSSTransition | scale | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | close | CSSTransition | opacity | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |
| dark | close | CSSTransition | scale | 120 | `cubic-bezier(0.16, 1, 0.3, 1)` |

## 証跡画像と判定範囲

- light: [2026-09-16-checkbox-preview-light.jpg](2026-09-16-checkbox-preview-light.jpg)
- dark: [2026-09-16-checkbox-preview-dark.jpg](2026-09-16-checkbox-preview-dark.jpg)
