...
# textarea preview 実ブラウザ検証（幾何レイヤー）
...
- selector: `[data-slot="textarea-preview"]`。light / dark は隔離 preview route を個別に開いた。

## 実測結果

| theme | route | HTTP | selector 件数 | console 総数 / favicon 除外後 | pageerror | dark class | 横 overflow | toolbar |
|---|---|---:|---:|---:|---:|---|---|---:|
| light | `/preview/textarea/` | 200 | 1 | 0 / 0 | 0 | false | なし | 0 |
| dark | `/preview/textarea-dark/` | 200 | 1 | 0 / 0 | 0 | true | なし | 0 |

favicon.ico の404は配信資産の既知の欠落として分離した。両テーマで主文書の高さは900pxで、viewport内を JPEG 撮影した。

## 証跡画像

- light: [2026-09-06-textarea-preview-light.jpg](2026-09-06-textarea-preview-light.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
- dark: [2026-09-06-textarea-preview-dark.jpg](2026-09-06-textarea-preview-dark.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
