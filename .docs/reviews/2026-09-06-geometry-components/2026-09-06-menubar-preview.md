...
# menubar preview 実ブラウザ検証（幾何レイヤー）
...
- selector: `[data-slot="menubar-content"]`。light / dark は隔離 preview route を個別に開いた。

## 実測結果

| theme | route | HTTP | selector 件数 | console 総数 / favicon 除外後 | pageerror | dark class | 横 overflow | toolbar |
|---|---|---:|---:|---:|---:|---|---|---:|
| light | `/preview/menubar/` | 200 | 1 | 0 / 0 | 0 | false | なし | 0 |
| dark | `/preview/menubar-dark/` | 200 | 1 | 0 / 0 | 0 | true | なし | 0 |
...
|---|---|---|---|---|
| light | `233px` | `12px` | `0.1s` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgb(222, 224, 227) 0px 0px 0px 1px, rgba(26, 28, 33, 0.08) 0px 4px 12px 0px` |
| dark | `233px` | `12px` | `0.1s` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgb(56, 61, 72) 0px 0px 0px 1px, rgba(0, 0, 0, 0.45) 0px 4px 12px 0px` |

## 証跡画像

- light: [2026-09-06-menubar-preview-light.jpg](2026-09-06-menubar-preview-light.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
- dark: [2026-09-06-menubar-preview-dark.jpg](2026-09-06-menubar-preview-dark.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
