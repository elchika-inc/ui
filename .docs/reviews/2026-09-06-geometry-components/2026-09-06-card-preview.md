...
- selector: `[data-slot="card"]`。light / dark は隔離 preview route を個別に開いた。

## 実測結果

| theme | route | HTTP | selector 件数 | console 総数 / favicon 除外後 | pageerror | dark class | 横 overflow | toolbar |
|---|---|---:|---:|---:|---:|---|---|---:|
| light | `/preview/card/` | 200 | 2 | 0 / 0 | 0 | false | なし | 0 |
| dark | `/preview/card-dark/` | 200 | 2 | 0 / 0 | 0 | true | なし | 0 |
...
|---|---|---|---|---|
| light | `189px` | `12px` | `0s` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(26, 28, 33, 0.04) 0px 1px 2px 0px` |
| dark | `189px` | `12px` | `0s` | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0.3) 0px 1px 2px 0px` |

## 証跡画像

- light: [2026-09-06-card-preview-light.jpg](2026-09-06-card-preview-light.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
- dark: [2026-09-06-card-preview-dark.jpg](2026-09-06-card-preview-dark.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
