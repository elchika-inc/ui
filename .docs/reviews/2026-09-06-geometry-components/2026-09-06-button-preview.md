...
- selector: `[data-slot="button"]`。light / dark は隔離 preview route を個別に開いた。

## 実測結果

| theme | route | HTTP | selector 件数 | console 総数 / favicon 除外後 | pageerror | dark class | 横 overflow | toolbar |
|---|---|---:|---:|---:|---:|---|---|---:|
| light | `/preview/button/` | 200 | 11 | 0 / 0 | 0 | false | なし | 0 |
| dark | `/preview/button-dark/` | 200 | 11 | 0 / 0 | 0 | true | なし | 0 |
...
|---|---|---|---|---|
| light | `36px` | `8px` | `0.12s` | `none` |
| dark | `36px` | `8px` | `0.12s` | `none` |

## 証跡画像

- light: [2026-09-06-button-preview-light.jpg](2026-09-06-button-preview-light.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
- dark: [2026-09-06-button-preview-dark.jpg](2026-09-06-button-preview-dark.jpg) — 1440×900px / JPEG / magic bytes `FF D8 FF`。
