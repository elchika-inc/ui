...
# signup-02 preview 実ブラウザ検証（幾何レイヤー）
...
- selector: `[data-slot="signup-02-preview"]`。light / dark は隔離 preview route を個別に開いた。

## 実測結果

| theme | route | HTTP | selector 件数 | console 総数 / favicon 除外後 | pageerror | dark class | 横 overflow | toolbar |
|---|---|---:|---:|---:|---:|---|---|---:|
| light | `/preview/signup-02/` | 200 | 1 | 0 / 0 | 0 | false | なし | 0 |
| dark | `/preview/signup-02-dark/` | 200 | 1 | 0 / 0 | 0 | true | なし | 0 |
